 ...
 * Полифилл живёт только в тестах — примитив рассчитан на настоящий браузер.
 * Воспроизводится то, на что опирается `Modal`: атрибут `open`, фокус внутрь
 * окна и цепочка Escape → отменяемое `cancel` → `close`.
 */
const FOCUSABLE =
