...
describe('BackupTriggerButton', () => {
  it('opens the confirm modal when the trigger is clicked', () => {
    render(<BackupTriggerButton />);
    expect(screen.queryByText('Создать бэкап?')).not.toBeInTheDocument();
  ...
  it('closes the modal via Cancel without calling the API', () => {
