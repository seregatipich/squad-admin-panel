...
/** Migrates the role-expirer package's template once; each worker slot gets a clone of it. */
export default function setupRoleExpirerTestDatabase(
  project: TestProject,
): Promise<() => Promise<void>> {
  return setupPackageTemplateDatabase(project, 'role_expirer');
}
