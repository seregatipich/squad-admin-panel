...
/** Migrates the seed-reward package's template once; each worker slot gets a clone of it. */
export default function setupSeedRewardTestDatabase(
  project: TestProject,
): Promise<() => Promise<void>> {
  return setupPackageTemplateDatabase(project, 'seed_reward');
}
