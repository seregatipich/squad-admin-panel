...
Returns a structured breakdown of the panel's disk footprint on the host. The Go-side computation lands in a follow-up commit; this document covers only the TS client surface. Timeout: 30 s.
