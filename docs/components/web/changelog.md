...
- Прямая кнопка Steam скрыта на время переходного выпуска. В меню модератора и шапке самообслуживания появились ссылка на сайт, выход только из панели и глобальный выход из сайта и панели.
