...
| `/settings/account` | `src/app/(dashboard)/settings/account/page.tsx` | Account identity (name + nickname history in the header) and session management — list active sessions, revoke individual or all. |
