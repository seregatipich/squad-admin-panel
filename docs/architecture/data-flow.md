...
|---|---|---|
| PostgreSQL | api, workers, db migrations | players, sessions, player_role_assignments, organizations, servers, config_versions, audit_log, events (partitioned monthly), processed_events |
